...
.top li a:hover{
    ...
    <style>
            ...
            body{
    background:url("images/feiyan_banner.png") no-repeat center center fixed;
...
<body >
		<div class="top">
                    ...
                    <ul>
                    <li><a href="index.jsp"><font  color="white">世界疫情</font></a></li>
                    <li><a href="china.jsp"><font  color="white">中国疫情</font></a></li>
                    <li><a href="city.jsp"><font  color="white">省市疫情</font></a></li>
                    <li><a href="Track.jsp"><font  color="white">疫情跟踪</font></a></li>
                    <li><a href="together.jsp"><font  color="white">同乘查询</font></a></li>
                   
                   <div class="slide-btn">
		<div class="inner-on" id="inner">
			<input style="display:none;" type="checkbox" checked>
			<span class="left">新闻</span><span class="space">&nbsp;</span><span class="right">辟谣</span>
		</div>
	</div>
            ...
            if(conn != null){  
                ...
                if(cha!=null&&cha!=""){
                	...
                	if(suoyin!=null&&suoyin!=""){
                		...
                		sql="SELECT * FROM news where "+suoyin+" like '%"+cha+"%'";
                		System.out.println("gdgdd");
                	}}
                }
                if(name!=null&&name!=""){
                	if(!name.equals("null")){
                		sql="select * from news where title like '%"+name+"%'";
                	}
                }
...
%>
			<div class="cd-timeline-block">
                ...
                <div class="cd-timeline-content">
                    ...
                    <a href="<%=rs.getString("link") %>" class="cd-read-more" target="_blank">阅读全文</a>
                    <span class="cd-date"><%=rs.getString("source") %></span>
                </div>
            </div>
...
<%
    ...
    <div class="page"  style=" text-align:center;">
				<div >
					<a class="sel_btn" id="sel_btn2"  href="News.jsp?page=<%=intPage-1%>&cha=<%=cha%>&suoyin=<%=suoyin%>&name=<%=name%>">上一页</a> 
					<span class="current" ><font  color="white"><%=intPage%></font></span>  
					<a  class="sel_btn" id="sel_btn2"   href="News.jsp?page=<%=intPage+1%>&cha=<%=cha%>&suoyin=<%=suoyin%>&name=<%=name%>">下一页</a>
				</div>
			</div>	
			</div>
			<%
...
<script>
		...
		var postURL = "/yiqing/ShowRCServlet";
		...
		chart.on('click', function(params) {
			var url = "News.jsp?name=" + params.name;
